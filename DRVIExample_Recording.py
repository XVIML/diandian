...
win.wm_title('MIC Recorder')

#==Layout of controls=====================
mLab1=dr.DRLabelX(win,40*wRate,32*hRate,500*wRate,40*hRate,'#004488','#ffffff','MIC Recorder',20)
mLab2=dr.DRLabel(win,600*wRate,120*hRate,600*wRate,40*hRate,'#ddeeee','#000000','X: 0 - 0.2 秒        Y: -1 - 1')
mHBut2=dr.DRHButtonGroup(win,40*wRate,100*hRate,200*wRate,36*hRate,'#0088aa','#ffffff','Start,Stop',2,0)
