...
mLab1=dr.DRLabelX(win,20*wRate,30*hRate,400*wRate,40*hRate,'#003355','#ffffff','典型信号波形和频谱',20)
...
mVButType=dr.DRRadioButX(win,940*wRate,80*hRate,120*wRate,140*hRate,'#004466','#000000','#ffffff','#00ccff','#eeee44','正弦波,方波,三角波,白噪声',11,4,0)
