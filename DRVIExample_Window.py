...
win.wm_title('Roles of Window Function')

#==Layout of controls=====================
dr.DRLabelX(win,20*wRate,30*hRate,400*wRate,40*hRate,'#440000','#ffffff','Roles of Window Function',20)
...
#==============
dr.DRLabelX(win,660*wRate,40*hRate,140*wRate,40*hRate,'#ddeeee','#000000','Frequency',16)
mDigital1=dr.DRDigital(win,800*wRate,40*hRate,120*wRate,40*hRate,'#000000','#00ffaa',45,2,22)
mSpin1=dr.DRSpinBox(win,960*wRate,40*hRate,100*wRate,36*hRate,'#ffffff','#000000',45,0.1,40,50)
